...
// RevenueCat webhook secret — set via: supabase secrets set REVENUECAT_WEBHOOK_SECRET=xxx
...
serve(async (req) => {
  ...
  // Try to match RevenueCat user ID to a Supabase player
  // Convention: the app sets RevenueCat user ID = Supabase auth.uid()
